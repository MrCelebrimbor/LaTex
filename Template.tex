...
\usepackage{geometry}                	
\geometry{paperheight=15cm,paperwidth=15cm,right=4cm,left=2cm,top=1cm,bottom=1cm,includeheadfoot,landscape=false
%,showframe%是否显示边框
}
 %支持中文
\usepackage{xeCJK}
...
%图表标题设置
\usepackage{caption}
\captionsetup{aboveskip=0pt,belowskip=0pt,font=small,labelfont=bf} %设置图表标题的格式
