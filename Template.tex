...
%图表标题设置
\usepackage{caption}
\captionsetup{margin=10pt,font=small,labelfont=bf} %设置图表标题的格式
...
%边注设置
\setlength{\marginparsep}{0mm}% 版心和边注的距离
\setlength{\marginparwidth}{0cm}% 边注的宽度
%脚注设置
\setlength{\footskip}{10mm}%页脚基线到正文基线的距离
\setlength{\footnotesep}{12pt}%两个注脚之间的距离 
\setlength{\skip\footins}{2mm}%脚注横线到正文最后一行基线的距离
%logo相关
\usepackage{graphicx}
\newlength\logolength
